...
Efficient helpers to check primality and find prime pairs with a fixed gap (twin/cousin/sexy primes), including “closest” prime pairs.

📚 Overview
This project provides a small Java toolkit around prime numbers:
...
Notes:
n is an even positive gap (e.g., 2 → twin primes, 4 → cousin primes, 6 → sexy primes).
All functions have unit tests to verify correctness.
